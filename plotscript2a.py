...
with open("fnnpred2a_plot", "rb") as fp:   #Pickling
    a = pickle.load(fp)

print('test')
with open("rnnpred2a_plot", "rb") as fp:   #Pickling
    b = pickle.load(fp)

with open("lstmpred2a_plot", "rb") as fp:   #Pickling
    c = pickle.load(fp)

with open("gprpred2a_plot", "rb") as fp:   #Pickling
    d = pickle.load(fp)

# open true SOH data values:
with open("true2a_plot", "rb") as fp:   #Pickling
    e = pickle.load(fp)
