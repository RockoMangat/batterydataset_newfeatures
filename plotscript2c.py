...
print('test')
with open("rnnpred2c_plot", "rb") as fp:   #Pickling
    b = pickle.load(fp)

with open("lstmpred2c_plot", "rb") as fp:   #Pickling
    c = pickle.load(fp)

with open("gprpred2c_plot", "rb") as fp:   #Pickling
    d = pickle.load(fp)

# open true SOH data values:
with open("true2c_plot.pkl", "rb") as fp:   #Pickling
    e = pickle.load(fp)
