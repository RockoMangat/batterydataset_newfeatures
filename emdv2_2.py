...
# test_df = pd.concat(testframes)  # ignore

X_trainall = train_df[train_df.columns[0]]
y_trainall = train_df[train_df.columns[1]]

# two training datasets for cycles
X_train1 = X_trainall.head(168-startingpoint)
X_train2 = X_trainall.tail(168-startingpoint)


# two training datasets for SOH
y_train1 = y_trainall.head(168-startingpoint)
y_train2 = y_trainall.tail(168-startingpoint)
...
X_test = testframes[testframes.columns[0]]
y_test = testframes[testframes.columns[1]]


X_test = X_test.head(168-startingpoint)
y_test = y_test.head(168-startingpoint)
...
# initiate model
model = MyModule(num_inputs=1, num_outputs=1, hidden_size=128, num_layers=1)
