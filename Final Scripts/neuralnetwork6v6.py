...
# test on B0006:
# pklfiles = ['dataset2.pkl', 'dataset1.pkl', 'dataset3.pkl', 'dataset4.pkl']

# test on B0007:
# pklfiles = ['dataset3.pkl', 'dataset1.pkl', 'dataset2.pkl', 'dataset4.pkl']
...
# for B0006
# df_training = dfcomb_final[:-166]
# df_test = dfcomb_final.tail(166)
...
# fnnpred4d_plot = {}
# fnnpred4d_plot[0] = unnormalized_val_results
# fnnpred4d_plot[1] = X_test.index
#
# with open("fnnpred4d_plot", "wb") as fp:   #Pickling
#     pickle.dump(fnnpred4d_plot, fp)

# #  if RNN:

# rnnpred4d_plot = {}
# rnnpred4d_plot[0] = unnormalized_val_results
# rnnpred4d_plot[1] = X_test.index
#
# with open("rnnpred4d_plot", "wb") as fp:   #Pickling
#     pickle.dump(rnnpred4d_plot, fp)

#
#  if LSTM:

# lstmpred4d_plot = {}
# lstmpred4d_plot[0] = unnormalized_val_results
# lstmpred4d_plot[1] = X_test.index
#
# with open("lstmpred4d_plot", "wb") as fp:   #Pickling
#     pickle.dump(lstmpred4d_plot, fp)


# true SOH:

# true4d_plot = {}
# true4d_plot[0] = dfcomb_final.tail(129)['Average SOH']
# true4d_plot[1] = dfcomb_final.tail(129).index
#
# with open("true4d_plot", "wb") as f:   #Pickling
#     pickle.dump(true4d_plot, f)
