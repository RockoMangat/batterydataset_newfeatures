# Used for Tests 1 and Tests 2 - training and testing on the same dataset for GPR only
# merges feature data together, normalises data, randomises and splits it, then passes through GPR
...
with open('dataset4.pkl', 'rb') as handle:
...
with open("gprpred2d_plot", "wb") as fp:   #Pickling
