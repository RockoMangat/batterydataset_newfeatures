...
dfcomb_final = dfcomb_final.drop(['Max ICA of 2nd peak', 'Max ICA of 2nd peak voltage', 'Max ICA (2nd)', 'Max ICA voltage (2nd)', 'Max temp time', 'v3'], axis=1)
...
with open("gprpred4c_plot", "wb") as fp:   #Pickling
