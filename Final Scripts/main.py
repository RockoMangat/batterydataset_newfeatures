# used to combine all the charging, discharging and ICA features from U_av_charge_CC3.py, U_av_dicharge_CC2.py and incrementalcapacity6v3.py
import pandas as pd
import pickle

from U_av_charge_CC3 import charge_data
from U_av_discharge_CC2 import discharge_data
from incrementalcapacity6v3 import ica_data

# select dataset: 0, 1, 2 or 3 - feature extraction for each dataset manually is changed - computational purposes
datasetno = 0
