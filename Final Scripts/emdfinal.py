# EMD residual extraction and training neural networks - Test 5
...
file_name = 'B0005.xlsx'
B0005.to_excel(file_name)
...
# model = MyModule(num_inputs=1, num_outputs=1, hidden_size=19)
...
# rnnpred5c_res_plot = {}
# rnnpred5c_res_plot[0] = val_results
# rnnpred5c_res_plot[1] = X_test.index
#
# with open("rnnpred5c_res_plot", "wb") as fp:   #Pickling
#     pickle.dump(rnnpred5c_res_plot, fp)


# #  if RNN TRUE:

# rnnpred5c_true_plot = {}
# rnnpred5c_true_plot[0] = val_results
# rnnpred5c_true_plot[1] = X_test.index
#
# with open("rnnpred5c_true_plot", "wb") as fp:   #Pickling
#     pickle.dump(rnnpred5c_true_plot, fp)
...
# lstmpred5c_res_plot = {}
# lstmpred5c_res_plot[0] = val_results
# lstmpred5c_res_plot[1] = X_test.index
#
# with open("lstmpred5c_res_plot", "wb") as fp:   #Pickling
#     pickle.dump(lstmpred5c_res_plot, fp)


# #  if LSTM TRUE:

# lstmpred5c_true_plot = {}
# lstmpred5c_true_plot[0] = val_results
# lstmpred5c_true_plot[1] = X_test.index
#
# with open("lstmpred5c_true_plot", "wb") as fp:   #Pickling
#     pickle.dump(lstmpred5c_true_plot, fp)
...
# true5c_plot = {}
# true5c_plot[0] = testset['SOH discharge 2']
# true5c_plot[1] = testset.index
#
# with open("true5c_plot", "wb") as f:   #Pickling
#     pickle.dump(true5c_plot, f)
