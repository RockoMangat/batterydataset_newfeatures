...
# train with datasets B0006, B0007, B00018 and test on B0005 only
...
# fnnpred4c_plot = {}
# fnnpred4c_plot[0] = unnormalized_val_results
# fnnpred4c_plot[1] = X_test.index
#
# with open("fnnpred4c_plot", "wb") as fp:   #Pickling
#     pickle.dump(fnnpred4c_plot, fp)

# #  if RNN:

# rnnpred4c_plot = {}
# rnnpred4c_plot[0] = unnormalized_val_results
# rnnpred4c_plot[1] = X_test.index
#
# with open("rnnpred4c_plot", "wb") as fp:   #Pickling
#     pickle.dump(rnnpred4c_plot, fp)

#
#  if LSTM:

# lstmpred4c_plot = {}
# lstmpred4c_plot[0] = unnormalized_val_results
# lstmpred4c_plot[1] = X_test.index
#
# with open("lstmpred4c_plot", "wb") as fp:   #Pickling
#     pickle.dump(lstmpred4c_plot, fp)


# true SOH:

# true4c_plot = {}
# true4c_plot[0] = dfcomb_final.tail(167)['Average SOH']
# true4c_plot[1] = dfcomb_final.tail(167).index
#
# with open("true4c_plot", "wb") as f:   #Pickling
#     pickle.dump(true4c_plot, f)
