# same as neuralnetwork6v5 but testing on dataset 18 only
# use LSTM model
import torch
...
# true SOH:
datatrue_plot = {}
datatrue_plot[0] = dfcomb_final.tail(129)['Average SOH']
datatrue_plot[1] = dfcomb_final.tail(129).index

with open("datatrue", "wb") as f:   #Pickling
    pickle.dump(datatrue_plot, f)
